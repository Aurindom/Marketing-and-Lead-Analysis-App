...
| Scoring | 7-dimension scoring. Dims 1-6 deterministic, Dim 7 (Overall Fit) via Claude Haiku. Confidence-weighted tier assignment (HOT / WARM / COLD). |
